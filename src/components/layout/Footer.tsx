  ...
  return (
    <footer className="w-full bg-gray-50 text-gray-700 border-t border-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10">
        {/* --- Brand Section --- */}
        <div>
          <h2 className="text-2xl font-extrabold mb-3 text-black">
            DARAZ.LITE
          </h2>
          <p className="text-gray-600 text-sm mb-4 leading-relaxed">
            We provide high-quality electronic gadgets that match your
            lifestyle. From everyday essentials to premium devices, we bring
